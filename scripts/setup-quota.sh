...
echo "🚀 Setting up API Key Quota System..."
echo ""
...
if ! grep -q "CRON_SECRET" .env.local; then
  ...
  echo "✅ Step 2: CRON_SECRET already set"
fi
...
echo ""
echo "✅ Step 4: Running Supabase migration..."
pnpm run db:push
echo "  ✅ Migration completed"

# Step 5: Check vercel.json
echo ""
echo "✅ Step 5: Checking vercel.json..."
if [ ! -f "vercel.json" ]; then
  echo "  ⚠️  vercel.json not found - will need to add cron config manually"
else
  if grep -q '"crons"' vercel.json; then
    echo "  ✅ Cron configuration found in vercel.json"
  else
    echo "  ⚠️  Add this to vercel.json:"
...
# Step 6: Type check
echo ""
echo "✅ Step 5: Type checking (may show pre-existing errors)..."
pnpm type-check 2>&1 | grep -i "quota\|quotamanager" || echo "   ✅ No quota-related errors"

echo ""
echo "=========================================="
echo "✅ Quota system setup complete!"
echo "=========================================="
echo ""
echo "📝 Next steps:"
